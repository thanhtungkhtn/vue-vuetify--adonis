          ...
          <div class="item">
            <div class="content">
              <router-link :to="`/${user.username}`">
                ...
                <strong v-if="user.tweets && user.tweets.length > 1">{{ user.tweets.length }}</strong>
              </router-link>
            </div>
          </div>
          <div class="item">
            <div class="content">
              <router-link :to="isOwner ? `/following` : `/${user.username}/following`">
                ...
                <strong v-if="user.following && user.following.length > 1">{{ user.following.length }}</strong>
              </router-link>
            </div>
          </div>
          <div class="item">
            <div class="content">
              <router-link :to="isOwner ? `/followers` : `/${user.username}/followers`">
                ...
                <strong v-if="user.followers && user.followers.length > 1">{{ user.followers.length }}</strong>
              </router-link>
            </div>
          </div>
          <div class="item">
            <div class="content">
              <router-link :to="isOwner ? `/favorites` : `/${user.username}/favorites`">
                ...
                <strong v-if="user.favorites && user.favorites.length > 1">{{ user.favorites.length }}</strong>
              </router-link>
            </div>
          </div>
        </div>
